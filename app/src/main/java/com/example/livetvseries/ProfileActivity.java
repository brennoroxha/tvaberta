...
public class ProfileActivity extends AppCompatActivity implements Validator.ValidationListener {
    ...
    Button btnSubmit, btnDeleteAccount;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnDeleteAccount = findViewById(R.id.btnDeleteAcc);
        ...
        btnDeleteAccount.setOnClickListener(view -> new DeleteAccount(ProfileActivity.this));
